...
export function renderFooter(numeroWhatsapp) {
  return `
    ...
    <a href="https://wa.me/${numeroWhatsapp}?text=Hola%2C%20tengo%20una%20duda%20sobre%20sus%20perfumes" target="_blank" rel="noopener" class="btn btn-secondary footer__whatsapp">Escríbenos por WhatsApp</a>
